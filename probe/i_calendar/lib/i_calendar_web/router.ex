defmodule ICalendarWeb.Router do
  use ICalendarWeb, :router

  import ICalendarWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {ICalendarWeb.Layouts, :root}
  ...
  scope "/", ICalendarWeb do
    ...
    live_session :current_user,
      on_mount: [{ICalendarWeb.UserAuth, :mount_current_user}] do
